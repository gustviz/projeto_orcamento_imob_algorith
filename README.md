# Gerador de orçamento de aluguel mensal para imobiliárias
...
3. Preencha os campos:
   ...
   - Tipo de Imóvel (Apartamento, Casa ou Estudio)
   - Número de Quartos
   - Vagas de Garagem
   - Se possui crianças (Sim/Não)
   - Número de Parcelas do Contrato (1 a 5)
